...
const TrueFocus: React.FC<TrueFocusProps> = ({
  ...
  useEffect(() => {
    // Initialize with first word focused to prevent initial jump
    ...
    <div className="focus-container" ref={containerRef}>
      {words.map((word, index) => {
        ...
        return (
          <span
            key={index}
            // FIX: The ref callback should not return a value. Changed from an implicit return `(el => ...)` to a block body `{ el => ... }` to fix the TypeScript error.
